...
function listen () {
  ...
  // const idPublisher = PeerId.createFromB58String('QmTvzVUurS91zTQ3y7GyTk3w6VzKPq8bF9z5oKVmiK9czf')
  ...
  peerPublisher.multiaddr.add(multiaddr('/ip4/127.0.0.1/tcp/10333'))
  peerPublisher.multiaddr.add(multiaddr('/ip4/192.168.230.131/tcp/10333'))
  ...
  setInterval(() => {
    ...
    // console.log(ps.getPeerSet()['QmTvzVUurS91zTQ3y7GyTk3w6VzKPq8bF9z5oKVmiK9czf'].peerInfo)
  }, 3000)
}
