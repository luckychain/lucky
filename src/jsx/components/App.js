    ...
    render() {
        ...
        return (
            <div>
                ...
                <div>{React.cloneElement(this.props.children, { blocks: this.state.blocks, peersStarData:this.state.peersStarData, setActiveKey:this.setActiveKey, activeKey:this.state.activeKey, searchSubmit:this.searchSubmit.bind(this)})}</div>
